import { ArrowDown, ArrowUp, Check, MoreHorizontal, Plus, Trash2 } from 'lucide-react';
        ...
        return (
          <Card key={exercise.id || `${exercise.exerciseId}-${exerciseIndex}`} className="overflow-hidden">
            <div className="flex flex-wrap items-start justify-between gap-3 border-b border-border/60 p-4">
              <div className="flex min-w-0 items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-[11px] text-muted-foreground">{metric.replace('_', ' + ').toLowerCase()}</p>
                </div>
              </div>
              <DropdownMenu>
            ...
            <div className="space-y-2 p-4">
              ...
              <Button type="button" variant="outline" size="sm" className="w-full" onClick={() => void onAddSet(exerciseIndex)}>
