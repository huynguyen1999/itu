...
export const REST_ROUTES = {
  ...
  habitCalendar: 'habits/calendar',
  habitProgress: 'habits/:habitId/progress',
  habitOccurrenceActionByDate: 'habits/:habitId/occurrence-action',
  habitProgressByHabit: 'habits/:habitId/progress',
  habitProgressById: 'habit-progress/:id',
  habitReminderSnooze: 'habit-reminder-deliveries/:id/snooze',
  habitReminderDismiss: 'habit-reminder-deliveries/:id/dismiss',
  habitReminderComplete: 'habit-reminder-deliveries/:id/complete',
  ...
  habitInsights: 'habits/:id/insights',
  ...
  trashExpenseRestore: 'expenses/:expenseId/restore',
  ...
  trashExpenseDelete: 'expenses/:expenseId',
